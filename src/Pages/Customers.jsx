...
function Customers({ className = "", bgImage }) {
  return (
    <div className={`relative py-12 px-4 sm:px-8 ${className}`}>
      {bgImage && (
        <>
          <img
            src={bgImage}
          ...
          />
          <div className="absolute inset-0 w-full h-full bg-blue-100 opacity-40 z-0 pointer-events-none" />
        </>
      )}
