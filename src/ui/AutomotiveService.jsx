  ...
  return (
    <div className="w-full">
      <div className="w-full bg-blue-100 h-1/2 sm:h-screen relative overflow-hidden">
        ...
        <Button
          className="absolute left-0 sm:top-[15rem] top-[10rem] cursor-pointer transform bg-black text-white text-[5px] sm:text-[10px] px-4 sm:px-2 py-1 font-semibold text-sm z-50 flex flex-row-reverse items-center whitespace-nowrap justify-center gap-2"
          style={{
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-6 px-10 md:px-12 xl:px-20 py-10 z-10 relative">
          ...
          <div className="w-full h-full relative flex items-center justify-center z-10">
            <img
              src="/ServicesPages/automotivelocksmith.png"
              alt="About Us"
